...
const (
	ProductService_ListProductsByShop_FullMethodName = "/product.ProductService/ListProductsByShop"
...
type ProductServiceClient interface {
	ListProductsByShop(ctx context.Context, in *ListProductsByShopRequest, opts ...grpc.CallOption) (*ListProductsByShopResponse, error)
...
func (c *productServiceClient) ListProductsByShop(ctx context.Context, in *ListProductsByShopRequest, opts ...grpc.CallOption) (*ListProductsByShopResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProductsByShopResponse)
	err := c.cc.Invoke(ctx, ProductService_ListProductsByShop_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	ListProductsByShop(context.Context, *ListProductsByShopRequest) (*ListProductsByShopResponse, error)
...
func (UnimplementedProductServiceServer) ListProductsByShop(context.Context, *ListProductsByShopRequest) (*ListProductsByShopResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListProductsByShop not implemented")
}
...
func _ProductService_ListProductsByShop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListProductsByShopRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).ListProductsByShop(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_ListProductsByShop_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ListProductsByShop(ctx, req.(*ListProductsByShopRequest))
	}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ListProductsByShop",
			Handler:    _ProductService_ListProductsByShop_Handler,
		},
		{
